/// Templates for Bloc feature structure
class BlocTemplates {
  static String indexFile(String name) => "export '${name}_bloc.dart';\n";

  static String blocFile(String name) {
...
''';
  ...
  static String eventFile(String name) {
    final pascalName = _toPascalCase(name);
